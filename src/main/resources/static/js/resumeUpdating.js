...
window.addEventListener('load', () => {
    ...
    function submitHandler(event) {
        ...
        return fetchAuthorized('/employee/resumes/update', data)
    }
    ...
    educationButton.addEventListener('click', () => {
        ...
        newEduCol.innerHTML =
            ...
            '<input class="form-control" name="educationInfos[' + eduCounter + '].institution" type="text" placeholder="Hardard" id="institution" required>' +
            '</div>' +
